...
gen_loss_history = []
monet_discr_loss_history = []
photo_discr_loss_history = []
...
for epoch in range(n_epoch):
  ...
  for real_monet,real_photo,_,_ in loader:
    ...
    monet_discr_loss_history.append(monet_discr_loss.item())
    photo_discr_loss_history.append(photo_discr_loss.item())
...
""" 
torch.save(monet_generator.state_dict(), '/gpfs/workdir/houdberta/output_monet/monet_generator.save')
torch.save(photo_generator.state_dict(), '/gpfs/workdir/houdberta/output_monet/photo_generator.save')
torch.save(monet_discriminator.state_dict(), '/gpfs/workdir/houdberta/output_monet/monet_discriminator.save')
torch.save(photo_discriminator.state_dict(), '/gpfs/workdir/houdberta/output_monet/photo_discriminator.save')


loss_history_csv = pd.DataFrame(list(zip(gen_loss_history, monet_discr_loss_history, photo_discr_loss_history)), columns=['gen_loss', 'monet_discr_loss_history', 'photo_discr_loss_history'])
